...
public class BlueRightLow extends _Autonomous {
    ...
    private BlueRightLow.State _state;
        ...
        switch (_state) {
            ...
            case RAISE_SLIDE:
                if (_justEntered) {
                    ...
                    _state = BlueRightLow.State.Move_Forward;
                    _justEntered = true;
                }
                break;
            case Turn_Claw:
                if(_justEntered){
                    ...
                    _state = BlueRightLow.State.OPEN_CLAW;
                    _justEntered=true;
                }
                break;
            case OPEN_CLAW:
            ...
            case Move_Forward:
                if(_justEntered){
                    ...
                    _state = BlueRightLow.State.Wait;
                    _justEntered=true;
                }
                break;
            ...
            case Wait:
                if(_justEntered){
                    ...
                    _state = BlueRightLow.State.Sense;
                    _justEntered=true;
                }
                break;
            ...
            case Sense:
                if (_justEntered) {
                    ...
                    _state = BlueRightLow.State.back;
                    _justEntered=true;
                }
                break;
...
//                break;
            case back:
                if (_justEntered) {
                    ...
                    _state = BlueRightLow.State.move_forward1;
                    _justEntered = true;
                }
                break;
            case move_forward1:
                if (_justEntered) {
                    ...
                    _state = BlueRightLow.State.Turn_Right;
                    _justEntered = true;
                }
                break;
//            case Turn_Right:
